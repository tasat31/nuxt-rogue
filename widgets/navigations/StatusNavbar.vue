<template>
  <div class="container absolute top-0">
    <ul class="flex justify-around mt-6">
      <li class="flex justify-start ma-3">
        ...
        <div class="ml-2 text-2xl">Player Name</div>
        <div class="ml-4 text-2xl">Lv. 10</div>
      </li>
      <li>
      ...
      <li class="ma-3">
        <button disabled type="button" class="py-2.5 px-5 mr-2 text-sm font-medium text-gray-900 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center">
